"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[613],{8050:function(e,t,n){n.d(t,{EK:function(){return O},ET:function(){return iw},ad:function(){return ii},hJ:function(){return n7}});var i,r,s=n(5568),a=n(8341),o=n(4794),l=n(7365),u=n(8376);n(2040);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n5{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new n8(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new n5(this.firestore,e,this._key)}}class n6{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new n6(this.firestore,e,this._query)}}class n8 extends n6{constructor(e,t,n){super(e,t,new eH(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let e=this._path.popLast();return e.isEmpty()?null:new n5(this.firestore,null,new B(e))}withConverter(e){return new n8(this.firestore,e,this._path)}}function n7(e,t,...n){if(e=(0,l.m9)(e),nZ("collection","path",t),e instanceof n3){let i=P.fromString(t,...n);return n1(i),new n8(e,null,i)}{if(!(e instanceof n5||e instanceof n8))throw new T(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let i=e._path.child(P.fromString(t,...n));return n1(i),new n8(e.firestore,null,i)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
